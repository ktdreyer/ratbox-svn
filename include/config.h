...
#define KLINEPATH	ETCPATH "/kline.conf"	/* kline file */
#define DLINEPATH	ETCPATH "/dline.conf"	/* dline file */
#define XLINEPATH	ETCPATH "/xline.conf"	/* xline file */
#define RESVPATH	ETCPATH "/resv.conf"	/* resv file */
#define KLINEPATHPERM	ETCPATH "/kline.conf.perm"	/* kline file */
#define DLINEPATHPERM	ETCPATH "/dline.conf.perm"	/* dline file */
#define XLINEPATHPERM	ETCPATH "/xline.conf.perm"	/* xline file */
#define RESVPATHPERM	ETCPATH "/resv.conf.perm"	/* resv file */
