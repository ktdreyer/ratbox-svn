...
/* 004  RPL_MYINFO, */ ":%s 004 %s %s %s oiwszcerkfydnxbauglZC biklmnopstveI bkloveI",
...
/* 218 RPL_STATSYLINE, */       "Y %s %d %d %d %lu/%lu %d.%d %d.%d %lu",
...
/* 350 */       NULL,
/* 351 RPL_VERSION, */          "%s(%s). %s :%s TS%dow",
...
/* 379 */       NULL,
/* 380 */       NULL,
/* 381 RPL_YOUREOPER, */        ":%s 381 %s :You have entered... the Super Mega Ultra Drama Zone!!!!!.",
...
/* 707 */	NULL,
/* 708 ERR_TARGCHANGE */	":%s 708 %s %s :Targets changing too fast, message dropped",
...
/* 724 RPL_TESTMASK */		":%s 724 %s %s@%s %d %d :Local/remote clients match",
