...
static struct 	ConfEntry *find_conf_item(const struct TopConf *top, const char* name)
{
	dlink_node *d;
 	struct ConfEntry* cf;
...
#if 0 /* XXX unused */
static int     remove_top_conf(char *name)
{
        struct TopConf *tc;
        dlink_node *ptr;
...
static void	conf_set_serverinfo_rsa_private_key_file(void *data)
{
#ifdef HAVE_LIBCRYPTO
	BIO *file;
...
static void	conf_set_serverinfo_name(void *data)
{
...
static void	conf_set_serverinfo_description(void *data)
{
	MyFree(ServerInfo.description);
	DupString(ServerInfo.description, (char*)data);
}

static void	conf_set_serverinfo_network_name(void *data)
{
	char *p;
...
static void	conf_set_serverinfo_network_desc(void *data)
{
	MyFree(ServerInfo.network_desc);
	DupString(ServerInfo.network_desc, (char*) data);
}

static void	conf_set_serverinfo_vhost(void *data)
{
...
static void	conf_set_serverinfo_vhost6(void *data)
{
#ifdef IPV6
...
static void	conf_set_serverinfo_max_clients(void *data)
{
	int max = *(int*)data;
...
static void	conf_set_serverinfo_max_buffer(void *data)
{
	ServerInfo.max_buffer = *(int*) data;
}

static void	conf_set_serverinfo_hub(void *data)
{
	int hub = *(int*) data;
...
static void	conf_set_modules_module(void *data)
{
...
static void	conf_set_modules_path(void *data)
{
#ifndef STATIC_MODULES
...
static void	conf_set_logging_log_level(void *data)
{
	int i;
...
static int	conf_begin_oper(struct TopConf* tc)
{
...
static int	conf_end_oper(struct TopConf* tc)
{
	struct ConfItem *yy_tmp;
...
static void	conf_set_oper_flags(void *data)
{
...
static void	conf_set_oper_name(void *data)
{
	int oname_len;
...
static void	conf_set_oper_user(void *data)
{
	char *p;
	char *new_user;
	char *new_host;
...
static void	conf_set_oper_password(void *data)
{
	if (yy_achead->passwd)
...
static void	conf_set_oper_rsa_public_key_file(void *data)
{
#ifdef HAVE_LIBCRYPTO
	BIO *file;
...
static void	conf_set_oper_encrypted(void *data)
{
...
static void	conf_set_oper_class(void *data)
{
	MyFree(yy_achead->className);
	DupString(yy_achead->className, (char *) data);
}

static void	conf_set_oper_global_kill(void *data)
{
	int yesno = *(int*)data;
...
static void	conf_set_oper_remote(void *data)
{
	int yesno = *(int*)data;
...
static void	conf_set_oper_kline(void *data)
{
	int yesno = *(int*)data;
...
static void	conf_set_oper_unkline(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_xline(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_gline(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_operwall(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_nick_changes(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_die(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_rehash(void *data)
{
	int yesno = *(int*) data;
...
static void	conf_set_oper_admin(void *data)
{
	int yesno = *(int*) data;
...
static void    conf_set_oper_hidden_admin(void *data)
{
        int yesno = *(int*) data;
...
static int	conf_begin_class(struct TopConf *tc)
{
	yy_class = make_class();
	return 0;
}

static int	conf_end_class(struct TopConf *tc)
{
	if(conf_cur_block_name != NULL)
	{       
...
static void	conf_set_class_name(void *data)
{
	DupString(yy_class->class_name, (char*) data);
}

static void	conf_set_class_ping_time(void *data)
{
...
static void	conf_set_class_number_per_ident(void *data)
{
	yy_class->max_ident = *(unsigned int *)data;
}

static void	conf_set_class_connectfreq(void *data)
{
	yy_class->con_freq = *(unsigned int *) data;
}

static void	conf_set_class_max_number(void *data)
{
	yy_class->max_total = *(unsigned int *) data;
}

static void	conf_set_class_sendq(void *data)
{
...
static int	conf_begin_listen(struct TopConf *tc)
{
	listener_address = NULL;
	return 0;
}

static int	conf_end_listen(struct TopConf *tc)
{
...
static void	conf_set_listen_port(void *data)
{
	conf_parm_t *args = data;
...
static void	conf_set_listen_address(void *data)
{
	MyFree(listener_address);
	DupString(listener_address, data);
}

static int	conf_begin_auth(struct TopConf *tc)
{
	struct ConfItem *yy_tmp;
...
static int	conf_end_auth(struct TopConf *tc)
{
	struct ConfItem *yy_tmp;
	struct ConfItem *yy_next;
...
static void	conf_set_auth_user(void *data)
{
	char *p;
	char *new_user;
	char *new_host;
...
static void	conf_set_auth_passwd(void *data)
{
	if (yy_achead->passwd)
		memset(yy_achead->passwd, 0, strlen(yy_achead->passwd));
	MyFree(yy_achead->passwd);
...
static void	conf_set_auth_encrypted(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_no_spoof_notice(void *data)
{
	int yesno = *(unsigned int *)data;
...
static void	conf_set_auth_spoof(void *data)
{
	MyFree(yy_achead->name);
...
static void	conf_set_auth_flags(void *data)
{
	conf_parm_t *args = data;
...
static void	conf_set_auth_exceed_limit(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_is_restricted(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_kline_exempt(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_need_ident(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_no_tilde(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_gline_exempt(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_auth_flood_exempt(void *data)
{
	int yesno = *(unsigned int *) data;
...
static void	conf_set_auth_redir_serv(void *data)
{
...
static void	conf_set_auth_redir_port(void *data)
{
...
static void	conf_set_auth_class(void *data)
{
	MyFree(yy_achead->className);
	DupString(yy_achead->className, data);
}

static int	conf_begin_resv(struct TopConf *tc)
{
	resv_reason = NULL;
	return 0;
}

static int	conf_end_resv(struct TopConf *tc)
{
	MyFree(resv_reason);
	resv_reason = NULL;
	return 0;
...
static void	conf_set_resv_channel(void *data)
{
...
static void	conf_set_resv_reason(void *data)
{
	MyFree(resv_reason);
	DupString(resv_reason, data);
}

static void	conf_set_resv_nick(void *data)
{
...
static void	conf_set_shared_kline(void *data)	
{
	int yesno = *(unsigned int*) data;
...
static int	conf_end_connect(struct TopConf *tc)
{
	if(conf_cur_block_name != NULL)
	{
...
static void	conf_set_connect_name(void *data)
{
...
static void	conf_set_connect_host(void *data)
{
	MyFree(yy_aconf->host);
	DupString(yy_aconf->host, data);
}

static void	conf_set_connect_send_password(void *data)
{
	if (yy_aconf->spasswd)
...
static void	conf_set_connect_accept_password(void *data)
{
	if (yy_aconf->passwd)
...
static void	conf_set_connect_port(void *data)
{
	yy_aconf->port = *(unsigned int*) data;
}

static void	conf_set_connect_aftype(void *data)
{
	char *aft = data;
...
static void	conf_set_connect_fakename(void *data)
{
	MyFree(yy_aconf->fakename);
	DupString(yy_aconf->fakename, data);
}

static void	conf_set_connect_encrypted(void *data)
{
	int yesno = *(unsigned int*) data;
...
static void	conf_set_connect_rsa_public_key_file(void *data)
{
#ifdef HAVE_LIBCRYPTO
	BIO *file;
...
static void	conf_set_connect_cryptlink(void *data)
{
	int yesno = *(unsigned int *) data;
...
static void	conf_set_connect_compressed(void *data)
{
#ifdef HAVE_LIBZ
	int yesno = *(unsigned int*) data;
...
static void	conf_set_connect_auto(void *data)
{
	int yesno = *(unsigned int *) data;
...
static void	conf_set_connect_hub_mask(void *data)
{
	if(hub_confs == NULL)
	{
		hub_confs = make_conf();
...
static void	conf_set_connect_leaf_mask(void *data)
{
	if(leaf_confs == NULL)
	{
...
static void	conf_set_connect_class(void *data)
{
	MyFree(yy_aconf->className);
	DupString(yy_aconf->className, data);
}

static void	conf_set_connect_cipher_preference(void *data)
{
#ifdef HAVE_LIBCRYPTO
...
static int	conf_begin_kill(struct TopConf* tc)
{
	if(yy_aconf)
	{
		free_conf(yy_aconf);
...
static int	conf_end_kill(struct TopConf *tc)
{
...
static void	conf_set_kill_user(void *data)
{
	char *p;
	char *new_user;
	char *new_host;
...
static void	conf_set_kill_reason(void *data)
{
	MyFree(yy_aconf->passwd);
	DupString(yy_aconf->passwd, data);
}

static int	conf_begin_deny(struct TopConf* tc)
{
	if(yy_aconf)
	{
		free_conf(yy_aconf);
...
static int	conf_end_deny(struct TopConf *tc)
{
	if (yy_aconf->host &&
...
static void	conf_set_deny_ip(void *data)
{
	MyFree(yy_aconf->host);
	DupString(yy_aconf->host, data);
}

static void	conf_set_deny_reason(void *data)
{
	MyFree(yy_aconf->passwd);
	DupString(yy_aconf->passwd, data);
}

static int	conf_begin_exempt(struct TopConf *tc)
{
	if(yy_aconf)
	{
		free_conf(yy_aconf);
...
static int	conf_end_exempt(struct TopConf *tc)
{
	if (yy_aconf->host &&
	    parse_netmask(yy_aconf->host, NULL, NULL) != HM_HOST)
	{
...
static void	conf_set_exempt_ip(void *data)
{
	MyFree(yy_aconf->host);
	DupString(yy_aconf->host, data);
}
...
static void	conf_set_general_anti_nick_flood(void *data)
{
	ConfigFileEntry.anti_nick_flood = *(unsigned int*) data;
}

static void	conf_set_general_max_nick_time(void *data)
{
	ConfigFileEntry.max_nick_time = *(unsigned int*) data;
}

static void	conf_set_general_max_nick_changes(void *data)
{
	ConfigFileEntry.max_nick_changes = *(unsigned int*) data;
}

static void	conf_set_general_max_accept(void *data)
{
	ConfigFileEntry.max_accept = *(unsigned int*) data;
}

static void	conf_set_general_anti_spam_exit_message_time(void *data)
{
	ConfigFileEntry.anti_spam_exit_message_time = *(unsigned int*) data;
}

static void	conf_set_general_ts_warn_delta(void *data)
{
	ConfigFileEntry.ts_warn_delta = *(unsigned int*) data;
}

static void	conf_set_general_ts_max_delta(void *data)
{
	ConfigFileEntry.ts_max_delta = *(unsigned int*) data;
}

static void	conf_set_general_havent_read_conf(void *data)
{
...
static void	conf_set_general_kline_with_reason(void *data)
{
	ConfigFileEntry.kline_with_reason = *(unsigned int*) data;
}

static void	conf_set_general_client_exit(void *data)
{
	ConfigFileEntry.client_exit = *(unsigned int*) data;
}

static void	conf_set_general_kline_with_connection_closed(void *data)
{
	ConfigFileEntry.kline_with_connection_closed = *(unsigned int*) data;
}

static void	conf_set_general_warn_no_nline(void *data)
{
	ConfigFileEntry.warn_no_nline = *(unsigned int*) data;
}

static void	conf_set_general_non_redundant_klines(void *data)
{
	ConfigFileEntry.non_redundant_klines = *(unsigned int*) data;
}

static void	conf_set_general_stats_o_oper_only(void *data)
{
	ConfigFileEntry.stats_o_oper_only = *(unsigned int*) data;
}

static void	conf_set_general_stats_P_oper_only(void *data)
{
	ConfigFileEntry.stats_P_oper_only = *(unsigned int*) data;
}

static void	conf_set_general_stats_k_oper_only(void *data)
{
	char *val = data;
...
static void	conf_set_general_stats_i_oper_only(void *data)
{
	char *val = data;
...
static void	conf_set_general_caller_id_wait(void *data)
{
	ConfigFileEntry.caller_id_wait = *(unsigned int*) data;
}

static void	conf_set_general_pace_wait_simple(void *data)
{
	ConfigFileEntry.pace_wait_simple = *(unsigned int*) data;
}

static void	conf_set_general_short_motd(void *data)
{
	ConfigFileEntry.short_motd = *(unsigned int*) data;
}

static void	conf_set_general_no_oper_flood(void *data)
{
	ConfigFileEntry.no_oper_flood = *(unsigned int*) data;
}

static void	conf_set_general_glines(void *data)
{
	ConfigFileEntry.glines = *(unsigned int*) data;
}

static void	conf_set_general_gline_time(void *data)
{
	ConfigFileEntry.gline_time = *(unsigned int*) data;
}

static void	conf_set_general_idletime(void *data)
{
	ConfigFileEntry.idletime = *(unsigned int*) data;
}

static void	conf_set_general_dots_in_ident(void *data)
{
	ConfigFileEntry.dots_in_ident = *(unsigned int*) data;
}

static void	conf_set_general_max_targets(void *data)
{
...
static void	conf_set_general_default_cipher_preference(void *data)
{
#ifdef HAVE_LIBCRYPTO
	struct EncCapability *ecap;
	char *cipher_name;
...
static void	conf_set_general_compression_level(void *data)
{
#ifdef HAVE_LIBZ
...
static void	conf_set_general_use_egd(void *data)
{
	ConfigFileEntry.use_egd = *(unsigned int*)data;
}

static void	conf_set_general_egdpool_path(void *data)
{
	MyFree(ConfigFileEntry.egdpool_path);
	DupString(ConfigFileEntry.egdpool_path, data);
}

static void	conf_set_general_ping_cookie(void *data)
{
	ConfigFileEntry.ping_cookie = *(unsigned int*)data;
}

static void	conf_set_general_disable_auth(void *data)
{
...
static void    conf_set_general_use_whois_actually(void *data)
{
...
static void	conf_set_general_burst_away(void *data)
{
	ConfigFileEntry.burst_away = *(unsigned int*)data;
}

#ifdef IPV6
static void	 conf_set_general_fallback_to_ip6_int(void *data)
{
	ConfigFileEntry.fallback_to_ip6_int = *(unsigned int*)data;
}
#endif

static void	conf_set_general_oper_umodes(void *data)
{
	set_modes_from_table(&ConfigFileEntry.oper_umodes, "umode", 
				umode_table, data);
}

static void	conf_set_general_oper_only_umodes(void *data)
{
	set_modes_from_table(&ConfigFileEntry.oper_only_umodes, "umode", 
				umode_table, data);
}

static void	conf_set_general_min_nonwildcard(void *data)
{
	ConfigFileEntry.min_nonwildcard = *(unsigned int*)data;
}

static void	conf_set_general_default_floodcount(void *data)
{
	ConfigFileEntry.default_floodcount = *(unsigned int*)data;
}

static void	conf_set_general_client_flood(void *data)
{
	ConfigFileEntry.client_flood = *(unsigned int*)data;
}

static void	conf_set_general_dot_in_ip6_addr(void *data)
{
	ConfigFileEntry.dot_in_ip6_addr = *(unsigned int*)data;
}

static void	conf_set_channel_use_except(void *data)
{
	ConfigChannel.use_except = *(unsigned int*)data;
}

static void	conf_set_channel_use_invex(void *data)
{
	ConfigChannel.use_invex = *(unsigned int*)data;
}

static void	conf_set_channel_use_knock(void *data)
{
	ConfigChannel.use_knock = *(unsigned int*)data;
}

static void	conf_set_channel_knock_delay(void *data)
{
	ConfigChannel.knock_delay = *(unsigned int*)data;
}

static void	conf_set_channel_knock_delay_channel(void *data)
{
	ConfigChannel.knock_delay_channel = *(unsigned int*)data;
}

static void	conf_set_channel_max_chans_per_user(void *data)
{
	ConfigChannel.max_chans_per_user = *(unsigned int*)data;
}

static void	conf_set_channel_quiet_on_ban(void *data)
{
	ConfigChannel.quiet_on_ban = *(unsigned int*)data;
}

static void	conf_set_channel_max_bans(void *data)
{
	ConfigChannel.max_bans = *(unsigned int*)data;
}

static void	conf_set_channel_persist_time(void *data)
{
	ConfigChannel.persist_time = *(unsigned int*)data;
}

static void	conf_set_channel_default_split_user_count(void *data)
{
	ConfigChannel.default_split_user_count = *(unsigned int*)data;
}

static void	conf_set_channel_default_split_server_count(void *data)
{
	ConfigChannel.default_split_server_count = *(unsigned int*)data;
}

static void	conf_set_channel_no_create_on_split(void *data)
{
	ConfigChannel.no_create_on_split = *(unsigned int*)data;
}

static void	conf_set_channel_no_join_on_split(void *data)
{
	ConfigChannel.no_join_on_split = *(unsigned int*)data;
}

static void	conf_set_channel_no_oper_resvs(void *data)
{
	ConfigChannel.no_oper_resvs = *(unsigned int*) data;
}

static void	conf_set_serverhide_flatten_links(void *data)
{
	ConfigServerHide.flatten_links = *(unsigned int*)data;
}

static void	conf_set_serverhide_hide_servers(void *data)
{
	ConfigServerHide.hide_servers = *(unsigned int*)data;
}

static void	conf_set_serverhide_disable_remote_commands(void *data)
{
	ConfigServerHide.disable_remote = *(unsigned int*)data;
}

static void	conf_set_serverhide_disable_local_channels(void *data)
{
	ConfigServerHide.disable_local_channels = *(unsigned int*)data;
}

static void	conf_set_serverhide_links_delay(void *data)
{
...
static void	conf_set_serverhide_hidden(void *data)
{
	ConfigServerHide.hidden = *(unsigned int*)data;
}

static void	conf_set_serverhide_disable_hidden(void *data)
{
