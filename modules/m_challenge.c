...
DECLARE_MODULE_AV1(challenge, challenge_load, NULL, NULL, NULL, NULL, NULL, "$Revision$");
#else
...
DECLARE_MODULE_AV1(challenge, NULL, NULL, challenge_clist, NULL, NULL, NULL, "$Revision$");
