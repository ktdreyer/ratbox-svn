...
$ WRITE OUTPUT "		{"
$ WRITE OUTPUT "			ilog(L_MAIN, ""Error: linked in module without a MAPI header..giving up"");"
...
$ WRITE OUTPUT "				{"
$ WRITE OUTPUT "					ilog(L_MAIN, ""Error: linked in module failed loading..giving up"");"
$ WRITE OUTPUT "					exit(70);"
$ WRITE OUTPUT "				}"
$ WRITE OUTPUT "				"
...
$ WRITE OUTPUT "			{"
$ WRITE OUTPUT "				ilog(L_MAIN, ""Error: Unknown MAPI version in linked in module..giving up"");"
$ WRITE OUTPUT "				exit(70);"
$ WRITE OUTPUT "			}				"
$ WRITE OUTPUT "		}                                        "
$ WRITE OUTPUT "	}"
